;; [[file:myinit.org::*Evil mode][Evil mode:1]]
(require 'evil)

(evil-mode 1)
;; Evil mode:1 ends here

;; [[file:myinit.org::*org-roam][org-roam:1]]
...
;; [[file:myinit.org::*ORGMODE Bullets set off][ORGMODE Bullets set off:1]]
...
;; ORGMODE Bullets set off:1 ends here

;; [[file:myinit.org::*Helm setup off][Helm setup off:1]]
;; (use-package helm
;;              :demand t
;;              :diminish helm-mode
;;              :init
...
;;              :ensure helm)
;; Helm setup off:1 ends here

;; [[file:myinit.org::*Diary setup off][Diary setup off:1]]
;; (add-hook 'diary-display-hook 'fancy-diary-display)
;; (add-hook 'list-diary-entries-hook 'include-other-diary-files)
;; (add-hook 'mark-diary-entries-hook 'mark-included-diary-files)
;; (setq org-agenda-include-diary t)
;; Diary setup off:1 ends here

;; [[file:myinit.org::*GOOGLECALENDAR setup][GOOGLECALENDAR setup:1]]
...
;; GOOGLECALENDAR setup:1 ends here

;; [[file:myinit.org::*Org-agenda setup][Org-agenda setup:1]]
...
(setq org-agenda-custom-commands
	 ...
	 ((agenda "")
	  (alltodo "")))))
;; Org-agenda setup:1 ends here

;; [[file:myinit.org::*Refile setup][Refile setup:1]]
...
;; Refile setup:1 ends here

;; [[file:myinit.org::*Custom faces set up][Custom faces set up:1]]
(custom-set-faces
...
;; Custom faces set up:1 ends here

;; [[file:myinit.org::*Mobile org setup][Mobile org setup:1]]
...
;; Mobile org setup:1 ends here

;; [[file:myinit.org::*Auto-complete][Auto-complete:1]]
...
;; [[file:myinit.org::*Ace-window Para saltar entre buffers][Ace-window Para saltar entre buffers:1]]
...
;; Ace-window Para saltar entre buffers:1 ends here

;; [[file:myinit.org::*Hungry-delete Para delete os espaços em branco; deletes all the whitespace when you hit backspace or delete][Hungry-delete Para delete os espaços em branco; deletes all the whitespace when you hit backspace or delete:1]]
(use-package hungry-delete
  :ensure t
  :config
(global-hungry-delete-mode))
;; Hungry-delete Para delete os espaços em branco; deletes all the whitespace when you hit backspace or delete:1 ends here

;; [[file:myinit.org::*Expand-region expand the marked region in semantic increments (negative prefix to reduce region)][Expand-region expand the marked region in semantic increments (negative prefix to reduce region):1]]
(use-package expand-region
:ensure t
:config 
(global-set-key (kbd "C-=") 'er/expand-region))
;; Expand-region expand the marked region in semantic increments (negative prefix to reduce region):1 ends here

;; [[file:myinit.org::*UNDO TREE clippboard][UNDO TREE clippboard:1]]
(use-package undo-tree
:ensure t
  :init
  (global-undo-tree-mode))
;; UNDO TREE clippboard:1 ends here

;; [[file:myinit.org::*CAPTURE 2 setup Zamansky][CAPTURE 2 setup Zamansky:1]]
...
(defadvice org-capture-destroy 
  ...
  (if (equal "capture" (frame-parameter nil 'name))  
    (delete-frame)))
;; CAPTURE 2 setup Zamansky:1 ends here

;; [[file:myinit.org::*PDF setup off][PDF setup off:1]]
;;(setenv "PATH" (concat (getenv "PATH") ":/Library/TeX/texbin/"))
;;(setq exec-path (append exec-path '("/Library/TeX/texbin/")))
;;CONFIGURAÇAO DO ID AUTOMATICO
;; PDF setup off:1 ends here

;; [[file:myinit.org::*Org Refile set up][Org Refile set up:1]]
...
;; Org Refile set up:1 ends here

;; [[file:myinit.org::*Macros INSERÇAO DO MATHJAX e outras macros][Macros INSERÇAO DO MATHJAX e outras macros:1]]
;;(fset 'DEMO
...
;; Macros INSERÇAO DO MATHJAX e outras macros:1 ends here

;; [[file:myinit.org::*Parenteses setup][Parenteses setup:1]]
(electric-pair-mode 1)
(setq electric-pair-preserve-balance nil)
;; Parenteses setup:1 ends here

;; [[file:myinit.org::*user init setup ?????][user init setup ?????:1]]
(setq user-init-file (or load-file-name(buffer-file-name)))
(setq user-emacs-directory (file-name-directory user-init-file))
;; user init setup ?????:1 ends here

;; [[file:myinit.org::*Org-Agenda setup Outro?????][Org-Agenda setup Outro?????:1]]
(custom-set-variables
 ...
 '(package-selected-packages
   '(evil-collection denote-menu denote orgalist mu4e-alert orgit which-key use-package undo-tree try org-gcal hungry-delete helm expand-region evil auto-complete auctex ace-window)))
;; Org-Agenda setup Outro?????:1 ends here

;; [[file:myinit.org::*Mu setup][Mu setup:1]]
...
;; [[file:myinit.org::*Avy - navigate by searching for a letter on the screen and jumping to it][Avy - navigate by searching for a letter on the screen and jumping to it:1]]
(use-package avy
:ensure t
:bind ("M-s" . avy-goto-word-1)) ;; changed from char as per jcs
;; Avy - navigate by searching for a letter on the screen and jumping to it:1 ends here

;; [[file:myinit.org::*iedit and narrow / widen dwim][iedit and narrow / widen dwim:1]]
...
;; [[file:myinit.org::*Misc packages][Misc packages:1]]
...
;; [[file:myinit.org::*Reveal.js][Reveal.js:1]]
